...
from resnet_extraction.VGG16 import DeepVGG16
from resnet_extraction.RESNET import DeepRESNET
from resnet_config import SIZE_PROJECTION, RANDOM_SEED, DISTANCE_THRESOLD
